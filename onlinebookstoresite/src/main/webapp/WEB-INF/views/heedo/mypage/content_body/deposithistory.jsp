...
<div id="insertAccount1" class="modal fade" role="dialog"> 
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	...
        	계좌번호<br>
        	<input type="number" id="banknum_deposit" placeholder="(-제외)계좌번호를 입력해주세요">
      </div>
      <div class="modal-footer">
       	<button type="button" class="btn btn-dark" id="accountConfirmBtn1">등록</button>
...
<script>
	...
	$("#acmodalbtn").click(function(){
		...
		$("#insertAccount1").modal('show');
	})
	$("#accountConfirmBtn1").click(function(){
		console.log('1111')
		$("#insertAccount1").modal('hide');
		var banknum=$("#banknum_deposit").val();
		var bank=$("#bankSelect_deposit").val();
