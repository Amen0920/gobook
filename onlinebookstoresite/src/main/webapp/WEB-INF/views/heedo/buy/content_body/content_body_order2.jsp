	...
	<table class="table table-bordered">
		<tr>
			...
			<td style="width:50%">
				...
				<div class="form-check-inline">
					<label class="form-check-label">
						<input type="radio" class="form-check-input" name="ship_option" value="1" <c:if test="${empty sessionScope.mnum }">checked</c:if> >새로입력
					</label>
				</div>
			</td>
		...
		<tr>
			...
			<td><input type="text" id="name"  class="textbox1" <c:if test="${empty sessionScope.mnum }">readonly="readonly" placeholder="주문자와 동일"</c:if>></td>
		...
		<tr>
			...
			<td>
				...
				<button type="button" class="btn btn-dark" id="searchAddrBtn"  onclick="searchShipAddr()">주소 검색</button><br>
				...
				<input type="text" id="addr4" placeholder="상세주소" >&nbsp<input type="text" id="addr5" placeholder="참고주소">
			</td>
...
<script type="text/javascript">
	...
	var sessionmnum=sessionStorage.getItem("mnum");
	if(sessionmnum==null){
	...
	if($("#searchAddrBtn").hasClass('disabled')){
		return
	}
